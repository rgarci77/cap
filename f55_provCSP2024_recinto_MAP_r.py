...
try:
  ...
  # Cojo la licencia de Spatial
    ...
    with io.open(ruta_log, "a", encoding="utf-8") as fictime:
        ...
        if int(mun_ini)  == 1:
            arcpy.AddMessage(
                time.ctime() + " Los procesos comienzan desde el municipio 1. Se genera una capa precfe nueva."
            )
            ...
            vshp_recp = arcpy.FeatureClassToFeatureClass_conversion(shp_rec, carpeta_proye, "precfe_" + codProv) #por si distinta proyeccion
        ...
        fictime.write(u'preparo rasters a las ' + time.ctime() + '\n')
        ...
        fictime.write(u'preparo vectorial a las ' + time.ctime() + '\n')
        ...
        arcpy.AddMessage(" N�mero de municipios del fichero:" + str(nunmun))
        fictime.write(u'N�mero de municipios del fichero: ' + str(nunmun) + '\n')
        ...
        ##                            arcpy.SelectLayerByAttribute_management("lyshprec", "CLEAR_SELECTION")
                ...
                fictime.write(u'TERMIN� el municipio  ' + str(mun) + '\n')
                fictime.write(u'*****************************************\n')
                arcpy.AddMessage("TERMIN� el municipio " + str(mun))
                arcpy.AddMessage("***********************")
        ...
        fictime.write(u'TERMINÉ el procesado municipio a municipio sin solapes a las ' + time.ctime()+ '\n')
        fictime.write(u'*****************************************\n')
        ...
        fictime.write(u'FIN ESTADISTICAS ********************' + '\n')

        #***********************************************
        #ajusto

        arcpy.AddMessage("inicio ajustes finales")
        fictime.write(u'inicio ajustes finales a las ' + time.ctime()+ '\n')
        ...
        if codProv in ['15', '27', '32', '36', '04', '11', '14', '18', '21', '23', '29', '41', '31', '06', '10', '01', '20', '48', '02', '13', '16', '19', '45', '07']:
            ...
            fictime.write(u'Redondeo de 10 en 10 desde 20 a 90 - Andalucia, Galicia, Navarra, Pais Vasco, Extremadura, CasMan, Baleares ' + time.ctime()+ '\n')
            ...
            fictime.write(u'Redondeo de 5 en 5 desde 20 a 90- Asturias, Madrid, CValenciana ' + time.ctime()+ '\n')
            ...
            arcpy.AddMessage("Redondeo a la unidad regla del 5 desde 20 a 90- FEGA: Aragon, Murcia, CasLeon, Rioja, Cantabria, Canarias de 10 a 90, Catalu�a de 20 a 100")
            fictime.write(u'Redondeo a la unidad regla del 5 desde 20 a 90- FEGA: Aragon, Murcia, CasLeon, Rioja, Cantabria, Canarias de 10 a 90, Catalu�a de 20 a 100)' + time.ctime()+ '\n')
        ...
        fictime.write(u'TERMINE TODO a las ' + time.ctime() + '\n')
        fictime.write(u'*****************************************\n')
        fictime.close()
        arcpy.AddMessage("TERMINE TODO a las " + time.ctime())
    ...
    arcpy.AddError(u"ERROR NO CONTROLADO: " + unicode(e))
    raise

finally:
    
    # Limpieza de temporales aunque el proceso haya fallado
    for temporal in temporales:
        try:
            if arcpy.Exists(temporal):
                arcpy.Delete_management(temporal)
